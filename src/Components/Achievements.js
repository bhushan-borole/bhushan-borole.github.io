...
const Achievements = () => {
  const items = [
    ...
    },
    {
      ...
      btnText: "See Action",
      btnUrl: "https://assistant.google.com/services/a/uid/000000ba7137f19f"
    }
  ]
  return (
    <section id="achievements" class="about background-alt">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          {
            items.map((data, i) => (
              <div class="col-sm-3 d-flex justify-content-center" key={i}>
                ...
                <Card style={{ width: '16rem', background: "#343a40", padding: "20px" }} className="text-center">
                  <Card.Img variant="top" src={data.img} />
                  <Card.Body >
                    <Card.Title style={{color: "rgba(255, 255, 255, 0.7)", fontSize: "18px"}}>{data.cardTitle}</Card.Title>
                    <br></br>
                    <Card.Text style={{color: "#74808a"}}><div dangerouslySetInnerHTML={{__html: data.cardText}}></div></Card.Text>
                    <Button
                      variant="contained"
                      color="default"
                      target="_blank"
